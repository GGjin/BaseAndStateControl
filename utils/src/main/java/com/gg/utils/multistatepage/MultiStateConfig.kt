...
data class MultiStateConfig(
    ...
    @DrawableRes
    val errorIcon: Int = R.drawable.state_error,
    val emptyMsg: String = "这里什么都没有",
    @DrawableRes
    val emptyIcon: Int = R.drawable.state_empty,
...
//    val defaultState: MultiState? = null
    ...
    class Builder {
        ...
        @DrawableRes
        private var errorIcon: Int = R.drawable.state_error
        private var emptyMsg: String = "这里什么都没有"

        @DrawableRes
        private var emptyIcon: Int = R.drawable.state_empty
